...
if ($_SESSION['id'])
{
    ...
    /*var_dump($id);*/
    try  { 
        $db->exec("UPDATE commentaires SET moderation = 1 WHERE id=".$id);	
        $db->exec("SELECT * FROM articles INNER JOIN commentaires ON commentaires.article_id=articles.id");	    
    }					
    catch(Exception $e)  {
    ...
    <div class="bg-white mb-5 containerback">	
        <div class="row">
            <div class="col-12 text-center answer">	
                <h2>Le commentaire a bien été validé. Vous allez être redirigé dans quelques instants !</h2>
